...
class DeviceTokenService extends BaseService {
  ...
  Future<Map<String, dynamic>> registerDeviceToken(
    ...
    try {
      ...
      final response = await post('/device-tokens', requestData);
  ...
  Future<Map<String, dynamic>> unregisterDeviceToken(String token) async {
    try {
      final response = await delete('/device-tokens/by-token', {'token': token});
  ...
  Future<Map<String, dynamic>> updateDeviceToken(
    ...
    try {
      ...
      final response = await put('/device-tokens', requestData);
  ...
  Future<List<DeviceToken>> getUserDeviceTokens() async {
    try {
      final response = await get('/device-tokens');
