...
class CartService extends BaseService {
  ...
  Future<Map<String, dynamic>> getCartDetail(String cartId) async {
    try {
      final response = await get('/ecommerce/cart/$cartId');
  ...
  Future<Map<String, dynamic>> createCartItem({
    ...
    try {
      final response = await post('/ecommerce/cart', {
  ...
  Future<void> removeCartItem({
    ...
    try {
      await delete('/ecommerce/cart/$cartItemId', {
        'product_id': productId,
      });
  ...
  Future<Map<String, dynamic>> updateCartItem({
    ...
    try {
      final response = await put('/ecommerce/cart/$cartItemId', {
        'product_id': productId,
        'qty': quantity,
      });
  ...
  Future<Map<String, dynamic>> applyCoupon({
    ...
    try {
      final response = await post('/ecommerce/coupon/apply', {
  ...
  Future<Map<String, dynamic>> removeCoupon({required String cartId}) async {
    try {
      final response = await post('/ecommerce/coupon/remove', {
        'cart_id': cartId,
      });
