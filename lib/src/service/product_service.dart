...
class ProductService extends BaseService {
  ...
  Future<Map<String, dynamic>> getProductDetail(String slug) async {
    final response = await get('/ecommerce/products/$slug');

    return response;
  }

  Future<List<Map<String, dynamic>>> getRelatedProducts(String slug) async {
    final response = await get('/ecommerce/products/$slug/related');
  ...
  Future<int?> getProductVariationId(
    ...
    final response = await post(
      '/ecommerce/products/$productId/variation',
  ...
  Future<Map<String, dynamic>?> getProductVariation(
    ...
    try {
      final response = await get(
        '/ecommerce/product-variation/$productId?${attributes.map((id) => 'attributes[]=$id').join('&')}',
      );
  ...
  Future<List<Map<String, dynamic>>> searchProducts(String query) async {
    final response = await get('/ecommerce/products?q=$query');
  ...
  Future<Map<String, dynamic>> getFlashSaleProducts() async {
    try {
      final response = await get('/ecommerce/flash-sales');
  ...
  Future<Map<String, dynamic>> getProductReviews(String slug) async {
    try {
      String endpoint = '/ecommerce/products/$slug/reviews';
  ...
  Future<Map<String, dynamic>> _submitReviewWithImages({
    ...
    try {
      final request = http.MultipartRequest(
        'POST',
        Uri.parse('${AppConfig.apiBaseUrl}/ecommerce/reviews'),
      );
  ...
  Future<Map<String, dynamic>> getFilters(int? categoryId) async {
    String endpoint = '/ecommerce/filters';
    if (categoryId != null) {
  ...
  Future<Map<String, dynamic>> getAllProducts({
    ...
    try {
      String endpoint = '/ecommerce/products';
