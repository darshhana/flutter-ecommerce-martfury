...
import 'package:martfury/src/view/widget/network_image_with_fallback.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildGeneralProductsSection(
    ...
    final products = controller.categoryProducts[0] ?? [];
    ...
    return Column(
      ...
      children: [
        ...
        ProductSlider(
          title: context.tr('home.all_products'),
          products: products.map((product) => {
            ...
            'onTap': () {
              _navigateToProduct(context, {
                ...
                'slug': product.slug,
                'image_with_sizes': {
                  'small': [product.imageWithSizes.small.first],
                },
  ...
  Widget _buildCategorySection(
    ...
    // Use general products (key 0) for all categories since categories don't have specific products
    final products = controller.categoryProducts[0] ?? [];
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Add general products section
                    _buildGeneralProductsSection(context, controller),
